...
## 👨‍💻 О себе
Я начинающий **DevOps-инженер**, студент НГТУ им. Р.Е. Алексеева (прикладная математика).
Интересуюсь автоматизацией, CI/CD и инфраструктурой.
Есть практический опыт работы с Docker, GitLab CI и Linux.

🎯 Цель — развиваться в DevOps и участвовать в реальных production-проектах.
